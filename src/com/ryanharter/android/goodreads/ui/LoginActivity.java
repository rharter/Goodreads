		...
		webview.setWebViewClient(new WebViewClient() {
			...
			public boolean shouldOverrideUrlLoading(WebView view, String url)
			{
				...
				if (url.startsWith("oauth"))
				{
					...
					// 					try {
					// 						User authorizedUser = GoodreadsService.getAuthorizedUser();
					...
					tokens.putExtra("com.ryanharter.android.goodreads.token", token);
					tokens.putExtra("com.ryanharter.android.goodreads.tokenSecret", tokenSecret);
